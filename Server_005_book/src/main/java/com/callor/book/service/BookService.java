 ...
 * 필수 메소드는 반드시 table을 기준으로 CRUD를 구현한다
 * 
 * Create	: insert()
 * Read		: select()
 * Update	: update()
...
public interface BookService {
	...
	//도서정보 데이터는 ISBN, 도서명, 출판사코드 등의 데이터가 포함.
	...
	//PK 한개를 전달받아 조회하는 method는 
	//	한개의 데이터만 return한다
	//	데이터 없을 때는 null을 있을 때는 실제 데이터가 담깅
	// 	DTO가 return된다.
	public BookDTO findById(String bk_isbn);
	
	//도서명을 1개 전달받아서 도서명으로 조회를 하고
	//그 결과를 도서명 1개를 return하는 기능 수행
